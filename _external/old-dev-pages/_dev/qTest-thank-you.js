...
export default function ThankYouPage() {
	...
	const mastheadSettings = {
		...
		title: 'Thank you qTest test page',
		background: {
			type: 'pattern',
			color: 'dark',
		},
	...
	const seoData = [];
	return (
		<BasePageWrapper title={'Thank you qTest test page'} seoData={seoData}>
			<BaseTemplateWrapper
			...
			>
				...
				<div className={`${styles['form-test']}`}>
					<p style={{ marginLeft: `250px` }}>Thank you for submitting the qTest Form</p>
				</div>
			</BaseTemplateWrapper>
		</BasePageWrapper>
	);

...
export default function Preference({ globalAlertData, footerMenu, menu }) {
	...
	const mastheadSettings = {
		...
		title: 'Preference form test page',
		background: {
			type: 'pattern',
			color: 'dark',
		},
	...
	const translatedPages = [
		{
			...
			uri: '/fr/_dev/preference-test-german',
		},
		{
			locale: {
				locale: 'de_DE',
			},
			uri: '/de/_dev/preference-test-german',
		},
	];
...
const formSampleData = {
	...
	COTitle: 'Preferences Form Test Title', // Reporting Title
	Initiative: 'SAP testing', // Initiative
	Product: 'Tricentis Preferences', // Product

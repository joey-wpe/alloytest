...
export default function QTest({ globalAlertData, footerMenu, menu }) {
	...
	const seoData = [];
	return (
		<BasePageWrapper title={'Qtest form test page'} seoData={seoData}>
	...
	const translatedPages = [
		{
			...
			uri: '/fr/_dev/qtest-trial',
		},
		{
			locale: {
				locale: 'de_DE',
			},
			uri: '/de/_dev/qtest-trial',
		},
	];
...
const formSampleData = {
	formID: '411',
	nextFormID: '25', // follow up form
	ContentOffer: 'Test Persona', // Persona
	COStage: 'Prospect', // Stage
	leadSource: 'TRI-Accelerator-qTest-Trial', // Form Name (this comes from the title of the form in WP)
	contentOffer: '', // CO Code. This code I pulled from the live site for testing
	COTitle: 'qTest Form Test Title', // Reporting Title (a form field in ACF)
	Initiative: 'SAP testing', // Initiative
	Product: 'Tricentis qTest', // Product
	AssetType: 'Analyst Research', // Content Type
	shouldFormPrefill: false, 
	redirectURL: '/_dev/qTest-thank-you', // redirect URL

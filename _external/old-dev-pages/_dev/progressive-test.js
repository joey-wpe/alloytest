...
export default function Progressive({ globalAlertData, footerMenu, menu }) {
	...
	const mastheadSettings = {
		...
		title: 'Progressive form test page',
		background: {
			type: 'pattern',
			color: 'dark',
		},
	...
	const translatedPages = [
		{
			...
			uri: '/fr/_dev/progressive-test',
		},
		{
			locale: {
				locale: 'de_DE',
			},
			uri: '/de/_dev/progressive-test',
		},
	];
...
const formSampleData = {
	...
	COTitle: 'progressive Form Test Title', // Reporting Title
	Initiative: 'SAP testing', // Initiative
	Product: 'Tricentis progressive', // Product
